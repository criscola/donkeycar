...
# # Settings for brightness and blur, use 'MULTIPLY' and/or 'BLUR' and/or 'CANNY' in
# # AUGMENTATIONS
...
# ROI_CROP_TOP = 46               # the number of rows of pixels to ignore on the top of the image
...
# DONKEY_GYM = True
# DONKEY_SIM_PATH = "/Users/travaz/Downloads/donkey-sim-mac.app/Contents/MacOS/Simulator" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
